...
<div className="mt-5 border border-brand-red px-4 py-3">
  <span className="block text-brand-black">
    Alles, was in diesem Artikel beschrieben wird, ist Teil eines Systems, das
    ich gemeinsam mit meinen Kunden aufbaue. Wenn Sie irgendwann sehen möchten,
    wie es auf Ihr Unternehmen zutrifft — der Link zu einem kostenlosen
    strategischen Audit befindet sich am Ende. Wenn nicht — nehmen Sie einfach
    mit, was nützlich ist.
  </span>
</div>
---
<EmailCapture
...
<div className="mt-5 border border-brand-black px-4 py-3">
  <span className="mt-2 block text-brand-black">
    Eine Skischule in den Alpen. Statt „wir bringen dir Skifahren bei" —
    Details, die nur ein erfahrener Fahrer bemerken würde: spezifische
    Offpiste-Routen, die nur einheimischen Guides bekannt sind; eine
    Trainingsphilosophie, die von Aksel Lund Svindal oder einem gewählten
    skandinavischen Ansatz abgeleitet ist; Erwähnung spezifischer
    Schneebedingungen und wie man sie liest. Das ist
...
**Mari Miavka** — Markenstrategie und Marketing für Sportunternehmen und Gründer:innen.
