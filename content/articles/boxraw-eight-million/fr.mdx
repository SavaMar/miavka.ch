...
sections:
  ...
  - id: "checklist-for-those-who-own-a-business"
    title: "Liste de contrôle en 18 points"
  - id: "whats-next"
    title: "Et ensuite ?"
---
...
<div className="mt-5 border border-brand-black px-4 py-3">
  <span className="block text-brand-black">
    ...
    <em> « Le cyclisme comme rituel quotidien, pas comme sport du week-end »</em>{" "}
...
<div className="mt-5 border border-brand-black px-4 py-3">
  <span className="mt-2 block text-brand-black">
    ...
    — des détails que seul un skieur expérimenté remarquerait : des itinéraires
    hors-piste spécifiques connus uniquement des guides locaux ; une philosophie
    d'entraînement inspirée d'Aksel Lund Svindal ou d'une approche scandinave
    choisie ; la mention de conditions de neige spécifiques et comment les
    interpréter. C'est
...
<div className="mt-5 border border-brand-black px-4 py-3">
  <span className="mt-2 block text-brand-black">
    ...
    Il s'agit de
    <strong> un moment de triomphe et de liberté après l'obstination</strong>. Et
    le client achète précisément ce moment, enveloppé dans du tissu.
  </span>
</div>
...
>
  <span style={{ color: "#efe7d8" }}>Réservez un appel découverte avec moi</span>
</a>

---

**Mari Miavka** — je construis des marques pour des espaces sportifs et des entreprises d'experts à travers l'Europe. J'écris sur la façon dont les entreprises locales deviennent des cultes — à travers le langage, l'image et la structure, pas seulement par le budget.
